...
<head>
  ...
  <style>{!! \File::get(base_path('packages/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('packages/unisharp/laravel-filemanager/public/js/script.js')) !!}</script>
